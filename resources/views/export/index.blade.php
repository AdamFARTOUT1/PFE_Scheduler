        ...
        <div style="margin-bottom: 25px;">
            ...
            <div class="grid" style="grid-template-columns: repeat(3, 1fr);">
                ...
                <div class="panel" id="card-affectation" onclick="selectDoc('affectation')"
                    ...
                    <span class="badge" id="badge-affectation"
                        style="background: #999; color: #fff; padding: 4px 10px; border-radius: 10px; font-size: 12px;">
                        Non sélectionné
                    </span>
                </div>
                ...
                <div class="panel" id="card-planning" onclick="selectDoc('planning')"
                    ...
                    <span class="badge" id="badge-planning"
                        style="background: #999; color: #fff; padding: 4px 10px; border-radius: 10px; font-size: 12px;">
                        Non sélectionné
                    </span>
                </div>
        ...
        <div id="format-section" style="display: none;">
            ...
            <div>
                ...
                <div id="spinner" style="display:none; margin-top: 15px;">
                    <span style="color: #999;">Génération en cours ...</span>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/export.js') }}?v={{ time() }}"></script>
@endsection